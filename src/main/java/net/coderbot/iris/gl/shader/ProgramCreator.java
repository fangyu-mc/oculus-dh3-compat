...
public class ProgramCreator {
	...
	public static int create(String name, GlShader... shaders) {
		...
		IrisRenderSystem.bindAttributeLocation(program, 0, "vPosition");
		IrisRenderSystem.bindAttributeLocation(program, 1, "iris_color");
		IrisRenderSystem.bindAttributeLocation(program, 2, "irisExtra");
