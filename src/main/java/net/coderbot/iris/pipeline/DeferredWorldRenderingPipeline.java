...
import net.coderbot.iris.compat.dh.DHCompatBridge;
...
public class DeferredWorldRenderingPipeline implements WorldRenderingPipeline, RenderTargetStateListener  {
	...
	private final DHCompatBridge dhCompat;
	...
	public DeferredWorldRenderingPipeline(ProgramSet programs) {
		...
		this.dhCompat = DHCompatBridge.create(this, programs);
	...
	public GlFramebuffer createDHFramebuffer(ProgramSource source, boolean translucent) {
		return renderTargets.createDHFramebuffer(
			translucent ? flippedAfterTranslucent : flippedAfterPrepare,
