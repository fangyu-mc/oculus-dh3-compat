...
public class TransformPatcher {
	...
	static {
		...
		transformer.setTransformation((trees, parameters) -> {
			for (PatchShaderType type : PatchShaderType.values()) {
				...
				// @Asek3 I have old GLSL-Transformer on JRE8, so I will off this
	...
	public static Map<PatchShaderType, String> patchDH(String vertex, String geometry, String fragment) {
		return transform(vertex, geometry, fragment, new Parameters(Patch.DH));
	}
